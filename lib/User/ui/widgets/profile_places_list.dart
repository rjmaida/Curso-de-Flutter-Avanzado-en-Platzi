...
class ProfilePlacesList extends StatelessWidget {
 ...
 Place place = Place(
      ...
      likes: 3,
      userOwner: UserModel(uid: '1', name: 'Test', email: 'test@test.com', photoURL: "https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?w=2000")
  );
  Place place2 = Place(
      name: "Mountains",
